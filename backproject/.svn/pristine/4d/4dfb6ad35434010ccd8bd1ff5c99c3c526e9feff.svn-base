...
@TableName("right_func_action")
public class RightFuncAction extends Model<RightFuncAction> {

    private static final long serialVersionUID = 4013659354269359761L;
    /**
     * 内码
     */
