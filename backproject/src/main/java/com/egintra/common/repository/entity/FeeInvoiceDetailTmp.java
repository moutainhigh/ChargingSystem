...
@TableName("fee_invoice_detail_tmp")
public class FeeInvoiceDetailTmp extends Model<FeeInvoiceDetailTmp> {

    private static final long serialVersionUID = 4263892734539199263L;
